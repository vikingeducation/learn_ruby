...
describe "#multiply" do
  ...
  it "multiplies two numbers" do
      expect(multiply(100,25)).to eq(2500)
      expect(multiply(0,10)).to eq(0)
      expect(multiply(18,1)).to eq(18)
      expect(multiply(1.8,100)).to eq(180)
      expect(multiply(18,1.0)).to eq(18.0)
  ...
  it "multiplies several numbers" do
      expect(multiply(10,5,5)).to eq(250)
      expect(multiply(0,10,5)).to eq(0)
      expect(multiply(1,2,2,2,2,2)).to eq(32)
      expect(multiply(-1,2,3,4)).to eq(-24)
      expect(multiply(-1,2,-3,4)).to eq(24)
      expect(multiply(2)).to eq(nil)
 end 
